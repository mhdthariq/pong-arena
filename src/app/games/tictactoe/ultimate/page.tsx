          ...
          >
            ...
            >
              ...
              <p className="text-blue-100 text-sm leading-relaxed">
                Ultimate Tic-Tac-Toe is played on a 3×3 grid of 3×3 Tic-Tac-Toe
                boards. To win, you need to win three smaller boards in a row.
                The catch: wherever you play determines which board your
                opponent must play in next. If sent to a completed board, your
                opponent may choose any available board.
              </p>
          ...
          >
            {gameResult ? (
              <div className="w-full text-center mb-8 animate-slide-up">
                <h2
                  className={`text-4xl font-bold mb-6 animate-pulse-slow ${
